...
033[1;92m.▀  ▀ ▀█▄▀▪▀▀ █▪·▀▀▀▀ ·▀▀▀▀  ▀  ▀  ▀  ▀ ·▀▀▀ •    ▀▀▀ ▀▀  █▪
 ...
 033[1;92m(__| |______________________________________________________| |__) 
033[1;98m(__| |______________________________________________________| |__)
         C.E.O : FAYSAL BILLAL MIR | C.O " C.E.O EMON HASAN
          ...
          SAHANTO AHMED, 
033[1;98m ( __| |_____________________________________________________| |__)
033[1;92m(__|_|_____________________________________________________|_|__)""")
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((k+"["+p+"•"+k+"]"+p+" Example : 786786,203040,223344"))
				self.pwlist()
				break
			elif f=="d":
				try:
...
def results(Shanto,Ahmed):
        ...
        if len(Rongbaaz Tm) !=0:
                print(("[CP] : "+str(len(Rongbaaz Tm))))
...
def wangsaff():
    ...
    os.system("xdg-open https://www.facebook.com/100466858653425?text=Assalamualaikum%20shanto ahmed,%20Rongbaaz Tm%20Shanto Ahmed%20SC%20SBF%20Rongbaaz Tm.%20Code:%20404")
    input(k+"\n[ "+p+"Back"+k+" ]"+p)
    menu()
